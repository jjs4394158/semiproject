...
<body>
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
	  ...
	  <!-- ======= Information Section ======= -->
    <section id="information" style="margin-top: 100px; height: 100px; display: flex; align-items: center; justify-content: center; width: 300px; margin-left: auto; margin-right: auto;">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 d-flex justify-content-center">
          <span style="font-size: 50px; font-family: var(--font-primary);">글 쓰기</span>
        </div>
      </div>
    </div>
  </section>
						...
						<div class="card-body">
							...
							<form action="bWrite" method="post" enctype="multipart/form-data">
								...
								<div class="row mb-3">
                  					...
                  					<div class="col-sm-10">
                    					<textarea name="bContents" class="form-control" style="height: 500px"></textarea>
                  					</div>
              					</div>
