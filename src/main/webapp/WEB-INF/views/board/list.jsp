...
<body>
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
	...
	<!-- ======= Information Section ======= -->
	<div class="container"  style="margin-top: 70px; height: 100px; display: flex; align-items: center; justify-content: center; width: 300px; margin-left: auto; margin-right: auto;">
		<div class="row">
		<div class="col-lg-12 d-flex justify-content-center">
			<span style="font-size: 50px; font-family: var(- -font-primary); ">자유게시판</span>
		</div>
		</div>
	</div>
	<br />
	...
	<div class="row justify-content-center" style=" display: flex; align-items: center;">
		...
		<div class="col-lg-6">
			...
			<div class="card">
				...
				<div class="card-body">
					<br />
					<form class="row g-3" action="bSearch" method="GET">
						<!-- 검색 카테고리 -->
						<div class="col-md-2">
					...
					<table class="table table-hover" style="text-align: center;">
						...
						<tbody>
							...
							<c:forEach var="list" items="${boardList}">
								<tr>
									<td>${list.BNum}</td>
									<td><a href="bView?bNum=${list.BNum}" style="color: black; text-decoration: underline;">${list.BTitle}</a></td>
									<td>${list.BWriter}</td>
									<td>${list.BDate}</td>
									<td>${list.BHit}</td>
									<td>${list.BLikes}</td>
					...
					<c:if test="${pages ne 0}">
						<div style="text-algin: center">
							...
							<div style="text-align: right; margin-right: 20px;">
								<a href="writeForm"
									style="color: white; background-color: skyblue; isplay: inline-block; padding: 6px 6px;">글쓰기</a>
							</div>
						</div>
					</c:if>
				</div>
